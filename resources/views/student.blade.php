...
<head>
    ...
    <title>Шутис хичээлийн бүртгэлиййн систем</title>
</head>
<body>
@include("navbar")
        ...
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Оюутны хичээлийн мэдээллийг оруулна уу</h5>
        ...
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://marketplace.canva.com/MAB7yqsko0c/1/screen_2x/canva-smart-little-schoolgirl--MAB7yqsko0c.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Хичээлийн мэлээллийг шинэчлэх</h5>
